        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex w-full shrink-0 flex-wrap gap-2 sm:w-auto">
            <a
              ...
              className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-semibold text-brand-700 transition hover:bg-brand-50 sm:flex-none"
            >
            ...
            <a
              ...
              className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-brand-950/25 px-3 py-2 text-xs font-semibold text-white ring-1 ring-white/25 transition hover:bg-brand-950/35 sm:flex-none"
            >
              Submit
